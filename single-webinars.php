        ...
        <div class="single_webinar_body">
            ...
            <div id="webinar_form" class="single_webinar_body_right contact_form_block">
                <div class="single_webinar_register cf_form">
                    <?php echo do_shortcode('[contact-form-7 id="8619" title="Register to Webinar" html_id="'. $result_title. '"]');?>
                </div>
                <div class="cf_form after_submit_block after_webinar_block">
                    ...
                    <a href="<?php echo get_post_type_archive_link('webinars')?>" class="btn red_btn big_red_btn">Go to webinars</a>
                </div>
            </div>
        </div>
    </div>
